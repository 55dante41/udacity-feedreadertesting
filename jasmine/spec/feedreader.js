...
$( function () {
	...
	describe( 'Initial Entries', function () {
		...
		it( 'are loaded and have atleast one entry', function () {
			expect( document.getElementsByClassName( 'feed' )[ 0 ].getElementsByClassName( 'entry' )
					.length )
				.not.toBe( 0 );
		} );
	} );
	...
	describe( 'New Feed Selection', function () {
		...
		it( 'loads and updates page with new entries', function () {
			expect( document.getElementsByClassName( 'feed' )[ 0 ]
					.getElementsByClassName( 'entry' )[ 0 ].textContent )
				.not.toBe( initialFirstEntryContent );
		} );
	} );
}() );
